Each tech (frontend, backend, foundry, etc..) must have: readme.md, to-do-backend/frontend/foundry.md, runbook.md, project_context.md file. Project_context.me is about the current state of the project, changelog.md is for the changes, runbook.md is about important commands/tasks we use to test or make the project work. 
Everytime we work on a different feature and/or we need to write/modify code, I want you to create a new branch
Everytime we change the code or write new code, the changelog.md, project_context.md, to-do.txt must be updated.
