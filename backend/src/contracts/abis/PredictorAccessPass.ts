export const predictorAccessPassAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
        "name": "_signalFriendMarketAddress",
        "type": "address",
    ...
    "outputs": [
      {
        "name": "actionType",
        "type": "uint8",
        "internalType": "enum PredictorAccessPass.ActionType"
      },
      {
        "name": "targetAddress",
        "type": "address",
