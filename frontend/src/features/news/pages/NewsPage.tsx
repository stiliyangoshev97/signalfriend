...
const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    date: '2025-12-18',
    category: 'general',
    summary: 'We\'re officially live! SignalFriend has launched on BNB Chain mainnet. Start accessing prediction signals today!',
    content: [
      'We\'re thrilled to announce that SignalFriend is now officially LIVE on BNB Chain mainnet! 🎉',
      'After extensive testing and community feedback during our beta phase, we\'re ready to bring decentralized prediction signals to everyone.',
      ...
      '• Browse prediction signals from verified predictors',
      ...
      'Welcome to the future of decentralized prediction signals! 🦊',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      'We\'re excited to announce the beta launch of SignalFriend - a decentralized NFT marketplace for prediction signals on BNB Chain!',
      ...
      '• Browse and purchase prediction signals from predictors using testnet tokens',
