      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label 
              htmlFor="signal-content-protected"
              className="block text-sm font-medium text-dark-200"
            >
              Signal Content (Protected)
            </label>
            <a
              href="/faq#signal-template"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-accent-gold hover:text-accent-gold/80 flex items-center gap-1 transition-colors"
            >
