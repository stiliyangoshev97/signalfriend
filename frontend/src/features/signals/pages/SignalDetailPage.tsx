      ...
      {isPredictorBlacklisted && (
        <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-red-400 font-semibold">Predictor Blacklisted</h3>
              <p className="text-red-400/80 text-sm mt-1">
                The predictor of this signal has been blacklisted for violating platform guidelines. 
                This signal cannot be purchased.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {hasReported ? (
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                  <div className="flex items-center gap-2 text-yellow-400">
                    ...
                    <span className="font-medium">You have reported this signal</span>
                  </div>
        ...
        <div className="space-y-6">
          ...
          <PurchaseCard
            ...
            isPredictorBlacklisted={isPredictorBlacklisted}
            contentId={signal.contentId}
            onPurchase={() => {
              // Double-check blacklist status before opening modal
